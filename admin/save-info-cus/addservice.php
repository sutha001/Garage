...
<body>
    ...
    ?>
    <div class="allfrom">
        <h1>บันทึกวันที่เข้ามาใช้บริการ</h1>
        <hr>
        <form action="info-re.php" method="post">
            <div class="row">
                <div class="col-4">
                    <label for="inputState" class="form-label">วันที่เข้าใช้บริการ</label>
                    <input type="date" name="date_access" class="form-control" placeholder="วันที่เข้าใช้บริการ" aria-label="วันที่เข้าใช้บริการ" required>
                </div>
            </div>
            <div class="row">
                <div class="col-4">
