...
<?php 
    ...
    mysqli_query($connect, "INSERT INTO spares (spares_type, spares_model, spares_details, spares_price, stock)
    VALUES ('$type_spare','$type_car', '$details_spare', '$price_spare', '$stock')");
